...
const Main = ({startGame, allowClickRock, allowClickPaper, allowClickScissor,
  clickRock, clickPaper, clickScissor, notAllowed, showRock, showPaper, showScissor,
  storePlayerName, rockSelected, paperSelected, scissorSelected,
  finalResult, showFinalResult, alreadySelected, setShowResult, dispatch, ACTION
